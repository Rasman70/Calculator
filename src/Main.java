...
public class Main {
    static int rom=2; // флаг римских цифр:
       public static void main(String[] args) {
           ...
           while (true) {
               ...
               int vote = Integer.parseInt(calc(str)); // результат вычислений
               switch (rom) {
                   case 0:
                   ...
                   case 2: // здесь обрабатываются римские числа
                       ...
                       if (vote >= 30 && vote < 40) System.out.print("XXX");
    ...
    public static String calc(String input) {
        int a=0, b=0;
        String[] masStr = input.split(" "); //разбиваем строку на массив строк
